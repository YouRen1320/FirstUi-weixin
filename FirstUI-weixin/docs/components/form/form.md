...
<fui-form id="form" top="{{0}}">
  <fui-input required label="姓名" model:value="{{name}}"></fui-input>
  <fui-input required label="手机号" model:value="{{mobile}}"></fui-input>
  <fui-button text="提交" bindclick="submit"></fui-button>
</fui-form>
```
