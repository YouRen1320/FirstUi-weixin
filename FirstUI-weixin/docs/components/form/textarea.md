...
```html
<fui-textarea label="标题" required placeholder="请输入内容"></fui-textarea>
```
...
<view class="fui-textarea__box">
  <fui-textarea textareaBorder radius="{{24}}" border-color="#FFB703" background-color="#f8f8f8" placeholder="请输入内容"></fui-textarea>
</view>
```
