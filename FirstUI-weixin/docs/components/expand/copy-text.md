...
`fui-copy-text` 组件默认长按文本即可触发简单的复制提示或操作菜单。
...
```html
<fui-copy-text text="长按文本复制" value="https://doc.firstui.cn"></fui-copy-text>
```
...
```html
<!-- 扩展按钮 -->
<fui-copy-text text="示例文本" buttons="{{['回复','评论']}}" bindclick="btnClick"></fui-copy-text>

<!-- 菜单方向: top, bottom, left, right -->
<fui-copy-text direction="bottom" text="示例文本"></fui-copy-text>
```
