...
```html
<fui-pagination total="{{100}}" bindchange="change"></fui-pagination>
```

## 展开型页码

```html
<fui-pagination total="{{1000}}" pageType="{{2}}" bindchange="change"></fui-pagination>
```

## 自定义按钮

```html
<fui-pagination total="{{100}}" custom>
  <fui-icon name="arrowleft" slot="prev"></fui-icon>
  <fui-icon name="arrowright" slot="next"></fui-icon>
</fui-pagination>
```
