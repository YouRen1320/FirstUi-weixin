...
```html
<fui-alert title="这是一条提示信息"></fui-alert>
```

## 不同类型

```html
<fui-alert type="success" isLeft title="成功提示"></fui-alert>
<fui-alert type="warn" isLeft title="警告提示"></fui-alert>
<fui-alert type="clear" isLeft title="错误提示"></fui-alert>
```

## 带描述信息

```html
<fui-alert type="info" isLeft title="提示标题" desc="这里是详细描述信息..."></fui-alert>
```

## 可关闭

```html
<fui-alert closable title="可关闭的提示" bindclose="onClose"></fui-alert>
```

## 自定义图标

```html
<fui-alert type="info" isLeft spacing title="自定义图标">
