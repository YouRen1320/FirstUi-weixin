...
Page({
  ...
  onLoad(options) {
    //内容可与tabs分开
    const vtabs = ['First UI', '快速上手', '更新日志', '升级指南', '设计规范', '自定义主题', 'FAQ']
			const contents = [{
					title: 'FirstUI组件库',
					img: wx.fui.resUrl()+'/cooperate/light/img_banner_3x.png',
				...
				{
					title: '快速上手',
					img: wx.fui.resUrl()+'/cooperate/dark/img_banner_3x.png',
