...
```html
<fui-upload-video url="https://example.com/upload" immediate bindsuccess="success"></fui-upload-video>
```

手动上传：

```html
<fui-upload-video url="https://example.com/upload" id="upload" bindsuccess="success"></fui-upload-video>
