...
```html
<fui-slider bindchange="onChange"></fui-slider>
```

## 显示值与自定义颜色

```html
<fui-slider showValue activeColor="#FFB703" blockColor="#FFB703"></fui-slider>
```

## 区间选择

```html
<fui-slider section min="{{100}}" max="{{800}}" value="{{200}}" endValue="{{600}}" bindchange="onChange"></fui-slider>
```
