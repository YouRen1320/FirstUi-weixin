...
<fui-date-picker show="{{show}}" type="{{3}}" bindchange="change"></fui-date-picker>
```

## 日期区间选择

```html
<fui-date-picker range show="{{show}}" type="{{3}}" bindchange="change"></fui-date-picker>
```

## 设置默认值与范围

```html
<fui-date-picker value="2023-10-01" minDate="2020-01-01" maxDate="2025-12-31" show="{{show}}" bindchange="change"></fui-date-picker>
```
