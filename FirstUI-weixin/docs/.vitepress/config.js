      ...
      "/components/": [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "SearchBar 搜索栏", link: "/components/form/searchbar" },
            ...
            { text: "FormField 表单域", link: "/components/form/form-field" },
            {
            ...
            { text: "Validator 表单验证", link: "/components/form/validator" },
          ],
        },
        {
          text: "布局组件",
          ...
          items: [
            ...
            { text: "Skeleton 骨架屏", link: "/components/layout/skeleton" },
            { text: "SafeArea 安全区", link: "/components/layout/safe-area" },
          ],
        },
        {
          text: "导航组件",
          ...
          items: [
            ...
            { text: "VTabs 纵向选项卡", link: "/components/navigation/vtabs" },
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Backdrop 遮罩层", link: "/components/feedback/backdrop" },
            {
              text: "BubbleBox 气泡框",
            ...
            { text: "LoadAni 加载动画", link: "/components/feedback/load-ani" },
            {
              text: "LoadMore 加载更多",
              link: "/components/feedback/loadmore",
            },
            { text: "Result 操作结果", link: "/components/feedback/result" },
            {
        ...
        },
        {
          ...
          items: [
            ...
            { text: "NoticeBar 通告栏", link: "/components/data/noticebar" },
            { text: "Animation 动画", link: "/components/data/animation" },
            { text: "Circle 进度环", link: "/components/data/circle" },
            { text: "CountDown 倒计时", link: "/components/data/count-down" },
            {
        ...
        },
        {
          ...
          items: [
            ...
            { text: "CopyText 长按复制", link: "/components/expand/copy-text" },
            {
              text: "CubicBezier 贝塞尔曲线",
              link: "/components/expand/cubic-bezier",
            },
            { text: "DataTag 数据标签", link: "/components/expand/data-tag" },
            {
