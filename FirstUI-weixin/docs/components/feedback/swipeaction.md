...
<fui-swipeaction-group>
  <fui-swipe-action bindclick="onClick">
    <fui-list-cell>默认菜单按钮</fui-list-cell>
  </fui-swipe-action>
</fui-swipeaction-group>
```
...
```html
<fui-swipeaction-group>
  <fui-swipe-action buttons="{{buttons}}" bindclick="onClick">
    <fui-list-cell>自定义按钮</fui-list-cell>
  </fui-swipe-action>
</fui-swipeaction-group>
...
```html
<fui-swipe-action disabled>...</fui-swipe-action>
```
