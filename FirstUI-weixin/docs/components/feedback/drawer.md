...
```html
<fui-button text="打开抽屉" bind:click="openDrawer"></fui-button>

<fui-drawer show="{{show}}" bind:close="closeDrawer">
...
```html
<fui-drawer show="{{show}}" direction="left" bind:close="closeDrawer">
