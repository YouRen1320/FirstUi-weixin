...
<fui-form-item label="手机号" asterisk prop="mobile">
  <fui-input borderBottom="{{false}}" padding="0" model:value="{{mobile}}"></fui-input>
</fui-form-item>
```
...
```html
<!-- label 右对齐，星号在右侧 -->
<fui-form-item label-align="right" asterisk-position="right" label="活动名称">
  <fui-input borderBottom="{{false}}" padding="0"></fui-input>
</fui-form-item>
```
