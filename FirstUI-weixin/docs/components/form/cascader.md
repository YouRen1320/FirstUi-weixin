...
```html
<fui-cascader options="{{options}}" bindcomplete="complete"></fui-cascader>
```

## 默认选中

```html
<fui-cascader options="{{options}}" value="{{value}}" activeColor="#FF2B2B" bindcomplete="complete">
</fui-cascader>
```
...
```html
<fui-cascader options="{{layerData}}" stepLoading bindchange="change" bindcomplete="complete">
</fui-cascader>
```
