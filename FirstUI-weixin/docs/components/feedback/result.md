...
```html
<fui-result type="success" title="操作成功" descr="详细描述信息..."></fui-result>
```

## 不同状态

```html
<fui-result type="warning" title="警告提示"></fui-result>
<fui-result type="fail" title="操作失败"></fui-result>
<fui-result type="waiting" title="等待处理"></fui-result>
```

## 自定义插槽内容

```html
<fui-result title="自定义内容">
