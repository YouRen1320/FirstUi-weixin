...
```html
<fui-select show="{{show}}" options="{{options}}" bindclick="onTap"></fui-select>
```
...
```html
<!-- 单选 -->
<fui-select show="{{show}}" options="{{items}}" type="select" bindconfirm="onConfirm"></fui-select>

<!-- 多选 -->
<fui-select show="{{show}}" options="{{items}}" multiple bindconfirm="onConfirm"></fui-select>
```
