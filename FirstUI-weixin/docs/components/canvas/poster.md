...
```html
<fui-poster id="generator" width="{{560}}" height="{{980}}" bindready="ready"></fui-poster>
```
...
Page({
  ...
  generate() {
    ...
    const posterData = {
      texts: [
        { type: 'text', text: 'First UI', x: 20, y: 50, size: 30, color: '#333' }
      ],
      imgs: [
        { type: 1, imgResource: '/static/logo.png', x: 0, y: 0, width: 100, height: 100 }
      ],
      // ... blocks, lines, qrcode
    }
